Module ModuleField
      ...
      Implicit none
                  Type Field !(Nx)
                        ...
                        Real(8) ::  Chi(1:NxMax)  !kai(Chi) Implicit format calculation use
								Real(8) ::  Ex2(1:NxMax)=0.d0
								Logical ::  ElectroMagnetic = .False. !.True. ->  magnetic field exist
                        contains
                   ...
                   EndType Field
                    ...
                    Type FieldOne  !to caculate the field that one sorts of particle produce
                        Integer(4) :: Nx=NxMax
                        Real(8) :: Dx=Inputdx,Dt=Inputdt
                        Real(8) ::  RhoOne(1:NxMax),ChiOne(1:NxMax)
								Real(8) ::  TOne(1:NxMax)
								!Real(8) ::  RhoOneMCC1(1:NxMax),RhoOneMCC2(1:NxMax)
								Real(8) :: JxOne(1:NxMax),EnergyOne(1:NxMax)
								!Real(8) :: JxOneMCC1(1:NxMax),EnergyOneMCC1(1:NxMax)
								!Real(8) :: JxOneMCC2(1:NxMax),EnergyOneMCC2(1:NxMax)
								!Real(8) :: HeatingRate(1:NxMax)
								!Real(8) :: MeanJxOne(1:NxMax)
                    EndType FieldOne
