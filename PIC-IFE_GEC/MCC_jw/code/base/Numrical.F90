Module Numrical
    ...
    !>------ ab.ZWZ -------------
    Function Trans3Dto2Da(v)
        Real(8) :: Trans3Dto2Da(3)
        Real(8) :: v(3)
        ...
        r = dsqrt(x*x+y*y)
        theta = datan(y/x)
        If (x <= 0) theta = theta + 3.141592653589793238D0
        Trans3Dto2Da(:) = (/z,r,theta/)
    End Function Trans3Dto2Da
    
    Function Trans2Dato3D(v)
        Real(8) :: Trans2Dato3D(3)
        Real(8) :: v(3)
        Real(8) :: x,y,z,r,theta
        z = v(1)
        r = v(2)
        ...
        y = r * Dsin(theta)
        Trans2Dato3D(:) = (/x,y,z/)
    End Function Trans2Dato3D
    
    !Function isPointInLine_3D(Point,Line)
    !    Logical :: isInLine
    !    Real(8) :: Point(3)
    !    Real(8) :: Line(2,3)
    !    
    !    isInLine = .false.
    !    If ((Line(1-s1)*(z2-s1)<=0 .and. .and.) Then
    !    End If
    !    
    !End Function isPointInLine_3D
