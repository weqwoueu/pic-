Module ModuleOneStepField
  ...
  Use Numrical
    ...
    contains
         ...
         subroutine FieldOneStep(Ns,FO,FG,FB,FS,PB,PBDO)
            Implicit none
            ...
            Class(ParticleBoundaryOne),intent(inOUT) :: PBDO(0:Ns)
            Call AccumulationField(FG,Ns,FO)
            Call FB%Updater(PB,FG,PBDO)
			...
			subroutine FieldOneStepExplicit(Ns,FO,FG,FB,FS,PB,PBDO)
            Implicit none
            Integer(4),intent(in) :: Ns
            Type(FieldOne),intent(in) :: FO(0:Ns)
            Type(Field),intent(inout) :: FG
            ...
            Call AccumulationField(FG,Ns,FO)
            Call FB%Updater(PB,FG,PBDO)
            Call UpdaterCoeFieldSolver2(FS,FG,FB)
            Call UpdaterFieldSolver(FS)
            Call UpdaterField(FG,FS,FB)
            return
        End subroutine FieldOneStepExplicit
    ...
    End subroutine AccumulationField
        ...
        subroutine UpdaterCoeFieldSolver(FS,FG,FB)
		  ...
		  subroutine UpdaterCoeFieldSolver2(FS,FG,FB)
            Implicit none
            Type(FieldSolver), intent(inout):: FS
            Type(Field), intent(in) :: FG
            Type(FieldBoundary), intent(in) :: FB
            ...
            End Associate
            return
        End subroutine UpdaterCoeFieldSolver2
